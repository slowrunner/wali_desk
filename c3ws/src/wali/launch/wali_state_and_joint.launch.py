# FILE: wali_state_and_joint.launch.py
# PURPOSE:  Launch robot and joint state publishers with Create3 URDF

# USES:  urdf/create3.urdf.xacro
...
def generate_launch_description():
    ...
    urdf_file_name = 'create3.urdf.xacro'


    urdf = os.path.join(
    #    get_package_share_directory('ros2_gopigo3_node'),'urdf',
        get_package_share_directory('wali'),
        urdf_file_name)
